...
function ProfileSection() {
    ...
    const Profile = () => {
        if (defaultData.image_url) {
            return (<img className="mb-3 rounded-full h-48 w-48" src={defaultData.image_url} alt="profile" />)
        } else {
        ...
        <div>
            <main className="bg-profile mt-20 py-20">
                <div className="container">
                    ...
                    <div
                        className="bg-[#F8F8F8] w-full h-[951px] mt-10 rounded-3xl p-12 flex gap-8">
                        <div className=" w-[35%] h-full flex justify-center">
                            <div className="w-full flex items-center flex-col">
                                ...
                                <p className="text-xl text-center font-bold text-[#6A4029]">Do you want to save the change?</p>
                                <button
                                    onClick={handleEdit}
