              ...
              <div className="card">
                <div className="navbar-card">
                  <div className="profile">
                    <img
                      src={require("src/assets/Ellipse 175.webp")}
                      alt="Ellipse"
                    />
                    <div>
                      <h5>Viezh Robert</h5>
        ...
        <div className="container">
          <div className="inner">
            <div className="w-full md:w-1/2 flex flex-col items-center mb-5">
              <h2 className="w-full md:w-2/3 text-center text-2xl mt-10 md:text-3xl font-bold text-center">
                Loved by Thousands of Happy Customer
              </h2>
              <p className="w-full text-center text-sm text-[#4F5665]">
