...
Website Coffeshop for simple Orders.

## About The Project

The Coffeeshop app lets users browse and order food and drink menus, pay online, pre-order, and
...
1. Clone the repo
   ```sh
   git clone https://github.com/permana017/Coffe-shop-FE
   ```
