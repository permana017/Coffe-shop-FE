...
function Navbar() {
    ...
    const listMenuActive = 'cursor-pointer mr-5 text-amber-800 text-md font-semibold border-b-2 border-amber-800 transition duration-300'
    const listMenuStyle = 'cursor-pointer mr-5 hover:text-amber-800 text-md hover:font-semibold hover:border-amber-800  hover:border-b-2 transition duration-300'
                    ...
                    <div className="flex justify-between items-center p-2 w-full">
                        ...
                        <div className="hidden md:flex">
                            <p
                                ...
                                className={location.pathname === '/' ? listMenuActive : listMenuStyle}>Home</p>
                            <p
                                onClick={() => handleOnClick('/products')}
                                className={location.pathname === '/products' ? listMenuActive : listMenuStyle}>Product</p>
                            <p
                                onClick={() => handleOnClick("/payment")}
                                className={location.pathname === '/payment' ? listMenuActive : listMenuStyle}>Your Cart</p>
                            <p
                                onClick={() => handleOnClick("/history")}
                                className={location.pathname === '/history' ? listMenuActive : listMenuStyle}>History</p>
                        </div>
                        <div className="hidden md:flex">
                            {
                                login
